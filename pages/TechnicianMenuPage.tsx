...
const TechnicianMenuPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-slate-50 pb-24 md:pb-8">
      {/* Profile Card */}
      <div className="bg-blue-500 p-6 border-b border-slate-800">
        <div className="flex items-center gap-4">
          <div className="w-20 h-13 rounded-full bg-white flex items-center justify-center text-blue-500 text-xl font-bold overflow-hidden">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs text-white capitalize">{technician?.status || 'pending'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="rounded-lg border border-blue-500 overflow-hidden">
          ...
          <Link 
            ...
            className="bg-blue-500 flex items-center gap-3 p-4 border-b border-blue-500 hover:bg-blue-300 transition-colors"
          >
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
            </svg>
            <span className="text-[#ffff]">Notifications</span>
          </Link>
          <Link 
            to={getSettingsLink()} 
      ...
      {/* Explore Section */}
      <div className="p-4">
        <h3 className="text-xs font-black uppercase tracking-widest text-blue-500 mb-3">Explore</h3>
        <div className="rounded-lg border border-blue-500 overflow-hidden">
          <Link 
            to="/blogs" 
            className="bg-blue-500 flex items-center gap-3 p-4 border-b border-blue-500 hover:bg-blue-300 transition-colors"
          >
            ...
            <span className="text-[#ffff]">Insights</span>
          </Link>
          <Link 
            to="/about" 
            className="flex items-center gap-3 p-4 border-b border-blue-500 hover:bg-blue-300 transition-colors"
      ...
      <div className="p-4">
        ...
        <div className="rounded-lg border border-blue-500 overflow-hidden">
          ...
          <Link 
            to="/terms" 
            className="bg-blue-500 flex items-center gap-3 p-4 hover:bg-blue-300 transition-colors"
          >
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span className="text-[#ffff]">Terms & Conditions</span>
          </Link>
        </div>
      </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 flex md:hidden border-t border-slate-500 p-3 justify-around z-50" style={{ paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom))' }}>
        ...
        <Link to="/technician-menu" className="flex flex-col items-center text-blue-500 transition-colors">
          <svg className="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
