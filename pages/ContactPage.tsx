        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
              <h2 className="text-2xl font-black text-blue-500 mb-6">Get In Touch</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[#0f172a] text-sm font-medium mb-1">Email Us</p>
                    <a 
                      href={`mailto:${CONTACT_EMAIL}`}
                      className="text-blue-500 text-lg font-bold hover:text-blue-500 transition-colors"
                    >
                      {CONTACT_EMAIL}
                    </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[#0f172a] text-sm font-medium mb-1">Call Us</p>
                    <a
                      href="tel:0738242743"
                      className="text-blue-500 text-lg font-bold hover:text-green-400 transition-colors"
                    >
                      0738242743
                    </a>
                    <p className="text-slate-600 text-xs mt-1">Mon - Fri, 8am - 6pm</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[#0f172a] text-sm font-medium mb-1">WhatsApp</p>
                    <a 
                    ...
                    <p className="text-slate-600 text-xs mt-1">Quick responses on WhatsApp</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
              <h2 className="text-2xl font-black text-blue-500 mb-6">Submit a Claim</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Name */}
                <div>
                  <label htmlFor="name" className="block text-[#0f172a] text-sm font-medium mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="email" className="block text-[#0f172a] text-sm font-medium mb-2">
                      Email Address *
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-[#0f172a] text-sm font-medium mb-2">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                ...
                {/* Claim Type */}
                <div>
                  <label htmlFor="claimType" className="block text-[#0f172a] text-sm font-medium mb-2">
                    Claim Type *
                  </label>
                  <select
                    id="claimType"
                ...
                {/* Subject */}
                <div>
                  <label htmlFor="subject" className="block text-[#0f172a] text-sm font-medium mb-2">
                    Subject *
                  </label>
                  <input
                    type="text"
                ...
                {/* Message */}
                <div>
                  <label htmlFor="message" className="block text-[#0f172a] text-sm font-medium mb-2">
                    Detailed Message *
                  </label>
                  <textarea
                    id="message"
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors resize-none"
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-500 text-sm">
              ...
              Average response time: <span className="text-slate-900 font-medium">within 24 hours</span>
            </p>
          </div>
        </div>
      </div>
