    ...
    <>
      ...
      <div className="min-h-screen bg-slate-950 text-slate-200 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-black text-white mb-8 text-center">Privacy Policy</h1>
          <p className="text-slate-400 text-sm text-center mb-12">Last updated: March 2026</p>
          ...
          <div className="space-y-8">
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              ...
              <h3 className="text-lg font-semibold text-blue-400 mb-3">From Technicians:</h3>
              ...
              <h3 className="text-lg font-semibold text-blue-400 mb-3">From Clients:</h3>
              <ul className="list-disc list-inside text-slate-300 space-y-2 mb-4">
                <li>Name</li>
                <li>Phone number</li>
                <li>WhatsApp number</li>
              ...
              <h3 className="text-lg font-semibold text-blue-400 mb-3">Automatically Collected:</h3>
              <ul className="list-disc list-inside text-slate-300 space-y-2 mb-4">
                <li>Device type</li>
              ...
              <h3 className="text-lg font-semibold text-blue-400 mb-3">From Bookings:</h3>
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              <h2 className="text-xl font-bold text-white mb-4">3. Why We Collect It</h2>
              <ul className="space-y-4">
                <li>
                  <span className="font-semibold text-blue-400">Contact details:</span>
                  <span className="text-slate-300"> To connect clients with technicians via WhatsApp for booking inquiries.</span>
                </li>
                <li>
                  <span className="font-semibold text-blue-400">Location:</span>
                  <span className="text-slate-300"> To show nearby technicians based on the client's area.</span>
                </li>
                <li>
                  <span className="font-semibold text-blue-400">Profile photos and portfolio:</span>
                  <span className="text-slate-300"> To display on the technician's public profile for clients to view.</span>
                </li>
                <li>
                  <span className="font-semibold text-blue-400">Email:</span>
                  <span className="text-slate-300"> To send account notifications, booking confirmations, and platform updates.</span>
                </li>
                <li>
                  <span className="font-semibold text-blue-400">Booking details:</span>
                  <span className="text-slate-300"> To log the lead and notify the relevant technician of the service request.</span>
                </li>
              </ul>
            </section>
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-300"><span className="font-semibold">Technician profiles:</span> All technician profile information is publicly visible to anyone visiting the platform.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">•</span>
                  <span className="text-slate-300"><span className="font-semibold">Client bookings:</span> When a client books a service, their booking details (name, phone, service requested, location) are shared with the specific technician they booked.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">•</span>
                  <span className="text-slate-300"><span className="font-semibold">Analytics:</span> Basic usage analytics are shared with Cloudflare and other analytics providers to help us understand platform usage.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">•</span>
                  <span className="text-slate-300"><span className="font-semibold">Third party sales:</span> We do NOT sell user data to any third parties.</span>
                </li>
              </ul>
            </section>
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              <h2 className="text-xl font-bold text-white mb-4">5. Third Party Services We Use</h2>
              <p className="text-slate-300 mb-4">We use the following services that access user data:</p>
              <ul className="space-y-3">
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Supabase</span>
                  <span className="text-slate-300"> — Stores all user accounts, technician profiles, and booking data.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Cloudinary</span>
                  <span className="text-slate-300"> — Stores all uploaded photos including profile photos and portfolios.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Cloudflare</span>
                  <span className="text-slate-300"> — Hosts the website and handles DNS. Provides security and analytics.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">WhatsApp</span>
                  <span className="text-slate-300"> — Used for all client-technician communication via click-to-chat.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Google</span>
                  <span className="text-slate-300"> — OAuth sign-in provider (if users choose to sign in with Google).</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">OpenStreetMap / Nominatim</span>
                  <span className="text-slate-300"> — Used for location detection to find nearby technicians. No GPS data is stored.</span>
                </li>
              </ul>
            </section>
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              <h2 className="text-xl font-bold text-white mb-4">7. Photos and Portfolio Content</h2>
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">•</span>
            ...
            <section className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
              <h2 className="text-xl font-bold text-white mb-4">9. Your Rights (Kenyan Data Protection Act 2019)</h2>
              <p className="text-slate-300 mb-4">Under Kenya's Data Protection Act 2019, you have the following rights:</p>
              <ul className="space-y-3">
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Right to be informed:</span>
                  <span className="text-slate-300"> Know what data we hold about you.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Right to correction:</span>
                  <span className="text-slate-300"> Request correction of inaccurate data.</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Right to erasure:</span>
                  <span className="text-slate-300"> Request deletion of your data (also known as "right to be forgotten").</span>
                </li>
                <li className="bg-slate-800/50 p-3 rounded-lg">
                  <span className="font-semibold text-white">Right to withdraw consent:</span>
                  <span className="text-slate-300"> Withdraw consent for data processing at any time.</span>
                </li>
              </ul>
              <p className="text-slate-300 mt-4">
