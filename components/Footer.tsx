    ...
    return (
      <div className="flex items-center gap-5">
        <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
          aria-label="Instagram" className="text-pink-500 hover:text-pink-500 transition-all hover:scale-110">
        ...
        <a href={X_URL} target="_blank" rel="noopener noreferrer"
          aria-label="X / Twitter" className="text-blue-500 hover:text-blue-400 transition-all hover:scale-110">
          <svg className={cls} fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href={waUrl} target="_blank" rel="noopener noreferrer"
          aria-label="WhatsApp" className="text-green-500 hover:text-emerald-400 transition-all hover:scale-110">
          <svg className={cls} fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-[#f8fafc] border-t border-slate-200">
      ...
      <div className="sm:hidden px-6 py-6 flex flex-col items-center gap-4">
        <Link to="/" className="text-[#0f172a] font-black text-sm uppercase tracking-widest">
          <span className="text-blue-500">Mekh</span>
        </Link>
        <SocialIcons size="sm" />
        <p className="text-blue-500 text-[10px] font-black uppercase tracking-widest text-center">
      ...
      <div className="hidden sm:block">
        <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12 mb-10">
            ...
            {/* Column 1 — Brand */}
            <div>
              <Link to="/" className="text-[#0f172a] font-black text-lg uppercase tracking-widest mb-3 inline-block">
                <span className="text-blue-500">Mekh</span>
              </Link>
              <p className="text-slate-600 text-sm leading-relaxed mb-5">
                Kenya's automotive services marketplace. Connect with verified automotive technicians near you for any car service you need.
              </p>
              <SocialIcons size="lg" />
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link to="/about"
                  className="text-slate-600 hover:text-[#0f172a] text-sm font-semibold block transition-colors">
                  About Us
                </Link>
                <Link to="/contact"
                  className="text-slate-600 hover:text-[#0f172a] text-sm font-semibold block transition-colors">
            ...
            <div>
              ...
              <div className="space-y-4">
                <a href="tel:0738242743"
                  className="flex items-center gap-3 text-slate-600 hover:text-[#0f172a] text-sm font-semibold transition-colors group">
                  <div className="w-8 h-8 rounded-xl bg-blue-200 border border-blue-300 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600/20 transition-all">
                ...
                <div className="flex items-center gap-3 text-slate-500 text-sm">
                  <div className="w-8 h-8 rounded-xl bg-blue-200 border border-blue-300 flex items-center justify-center flex-shrink-0">
          ...
          <div className="border-t border-slate-200 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-blue-500 text-[11px] font-black uppercase tracking-widest">
              &copy; {currentYear} {BUSINESS_NAME}. Car Service Marketplace. Verified Technicians. Nairobi, Kenya.
            </p>
            <p className="text-blue-500 text-[10px] uppercase tracking-widest">
